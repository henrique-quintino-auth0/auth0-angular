(function (global, factory) {
    ...
    (global = global || self, factory(global.ng.core,global.ng.common,global.auth0.auth0SpaJs,(global.auth0 = global.auth0 || {}, global.auth0['auth0-angular'] = {}), global.ng.core, global.auth0SpaJs, global.rxjs, global.rxjs.operators, global.ng.router, global.ng.common));
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthClientConfig, [{
    ...
    var AuthService = /** @class */ (function () {
        ...
        AuthService.prototype.getAccessTokenSilently = function (options) {
            var _this = this;
            return rxjs.of(this.auth0Client).pipe(operators.concatMap(function (client) { return client.getTokenSilently(options); }), operators.tap(function () { return _this.refreshState$.next(); }), operators.catchError(function (error) {
                _this.errorSubject$.next(error);
        ...
        AuthService.prototype.getAccessTokenWithPopup = function (options) {
            var _this = this;
            return rxjs.of(this.auth0Client).pipe(operators.concatMap(function (client) { return client.getTokenWithPopup(options); }), operators.tap(function () { return _this.refreshState$.next(); }), operators.catchError(function (error) {
                _this.errorSubject$.next(error);
                return rxjs.throwError(error);
            }));
        };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthModule, [{
    ...
    var AuthHttpInterceptor = /** @class */ (function () {
        ...
        AuthHttpInterceptor.prototype.intercept = function (req, next) {
            ...
            // outgoing request
            rxjs.of(route).pipe(operators.pluck('tokenOptions'), operators.concatMap(function (options) { return _this.authService.getAccessTokenSilently(options); }), operators.switchMap(function (token) {
